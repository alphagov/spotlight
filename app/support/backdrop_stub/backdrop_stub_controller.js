define(['extensions/controllers/controller'], function (Controller) {

  var BackdropStubController = Controller.extend({
    ...
    fetch_json: function (request) {
      _.each(stub_mappings, function(mapping) {
        ...
        if (_.extend(request_params, mapping.key) == request_params) {
    ...
    invoke: function(req, res) {
      var json = this.fetch_json(req);
      return res.json({});
    }

  });

  return BackdropStubController;
