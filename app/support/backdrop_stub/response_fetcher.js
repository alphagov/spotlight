...
define(['extensions/models/model', 'lodash', 'fs', 'path'], function (Model, _, fs, path) {
  ...
  var ResponseFetcher = Model.extend({
    ...
    stubMappings: [
      ...
      { 'key': {'service': 'carers-allowance', 'api_name': 'time-taken-to-complete'}, 'file':  'carers-allowance-time-taken-to-complete.json'},
      { 'key': {'service': 'carers-allowance', 'api_name': 'time-spent-on-each-page'}, 'file':  'carers-allowance-time-spent-on-each-page.json'},
      { 'key': {'service': 'apply-carers-allowance', 'api_name': 'customer-satisfaction'}, 'file':  'carers-allowance-user-satisfaction.json'},
      { 'key': {'service': 'apply-carers-allowance', 'api_name': 'test-customer-satisfaction'}, 'file':  'carers-allowance-user-satisfaction-test.json'},
