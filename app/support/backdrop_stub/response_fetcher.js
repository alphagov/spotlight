define(['extensions/models/model', 'underscore', 'fs', 'path'], function (Model, _, fs, path) {
  ...
  var ResponseFetcher = Model.extend({
    ...
    stub_mappings: [
      ...
      { 'key': {'service': 'g-cloud', 'api_name': 'proportion-sme-monthly'}, 'file': 'g-cloud-proportion-smes-spend.json'}, // TODO: Get rid of this line. 
      { 'key': {'service': 'g-cloud', 'api_name': 'proportion-sme-monthly', 'collect': 'monthly_spend'}, 'file': 'g-cloud-proportion-smes-spend.json'},
      { 'key': {'service': 'g-cloud', 'api_name': 'proportion-sme-monthly', 'collect': 'count'}, 'file': 'g-cloud-proportion-smes-count.json'}   
    ],
