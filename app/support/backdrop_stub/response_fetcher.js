define(['extensions/models/model', 'underscore', 'fs', 'path'], function (Model, _, fs, path) {
  ...
  var ResponseFetcher = Model.extend({
    ...
    stub_mappings: [
      ...
      { 'key': {'service': 'gcloud', 'api_name': 'sales', "collect": "monthly_spend", "period": "month", "group_by": "sme_large"}, 'file': 'g-cloud-procurement.json'},
      { 'key': {'service': 'gcloud', 'api_name': 'sales', "collect": "count", "period": "month", "group_by": "sme_large"}, 'file': 'g-cloud-procurement-count.json'},
