  ...
  describe("renderPng", function () {
    describe("getScreenshotPath", function () {
      ...
      it("creates the URL for the screenshot service call", function () {
        ...
        expect(screenshotPath).toEqual('http://screenshotservice?readyExpression=$("body").hasClass("ready")&forwardCacheHeaders=true&clipSelector=.visualisation&url=http://spotlight/test/path');
      });
    });
  });
});
